...
public class BookController {
    ...
    public ResponseEntity<BookResponse> addBooks(@RequestBody BookRequest body) throws NotFoundException {
    ...
    public BookResponse getBook(@PathVariable("id") Long bookId) throws NotFoundException {
        return new BookResponse(this.service.getBookById(bookId));
    }
    ...
    public BookResponse updateBook(@PathVariable("id") Long bookId, @RequestBody BookUpdateRequest body) throws NotFoundException {
        return new BookResponse(this.service.updateBook(bookId, body));
    }
